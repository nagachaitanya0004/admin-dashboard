...
export default function StatCard({ title, value, change, changeType, icon: Icon, color, loading }) {
  if (loading) {
    return (
      <div className="bg-white/[0.02] border border-white/[0.04] rounded-2xl p-6 h-[140px] flex flex-col justify-between overflow-hidden relative">
  ...
  return (
    <div className="group bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 hover:bg-white/[0.04] hover:-translate-y-1 hover:shadow-glass-glow transition-all duration-300 cursor-default relative overflow-hidden">
